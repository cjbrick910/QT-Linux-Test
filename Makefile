...
CFLAGS        = -pipe -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
distdir: FORCE
	...
	$(COPY_FILE) --parents window.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
